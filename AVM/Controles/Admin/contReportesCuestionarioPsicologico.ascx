<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="contReportesCuestionarioPsicologico.ascx.cs" Inherits="AVM.Controles.Admin.contReportesCuestionarioPsicologico" %>
