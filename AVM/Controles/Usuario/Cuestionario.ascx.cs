...
{
    public partial class Cuestionario : System.Web.UI.UserControl, ICuestionario, IAlumno
    {
        ...
        protected void ButtonAgregarDental_Click(object sender, EventArgs e)
        {
            ...
            if (Estado)
            {
                ...
                Response.Redirect("Cuestionarios.aspx");
        ...
        protected void ButtonAcuse_Click(object sender, EventArgs e)
        {
            ...
            string cadenaFinal = "";
            string path = Server.MapPath("../../Imagenes/universidad/Acuse.png");
