...
namespace Core.Presenter
{
    public class WAlumno
    {
        ...
        public void EliminarAlumno(CAlumno objAlumno, int opcion)
        {
            bool BolRegistro = false;
            ...
            if (ExisteConexion())
            {
                 ...
                 BolRegistro = objAlumno.ConfigurarUsuario(opcion, objAlumno);
        ...
        public void AltaAlumno(CAlumno objAlumno, int opcion)
        {
            bool BolRegistro = false;
            ...
            if (ExisteConexion())
            {
                    ...
                    BolRegistro = objAlumno.insertAlumno(opcion, objAlumno); 

                
                if (BolRegistro == true)
                {
                    ViewAlumno.Mensaje("Alumno registrado", 1);
                    //Se reguistro la cita, enviar mensaje al médico
